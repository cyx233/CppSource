...
QT_MOC_LITERAL(5, 68, 23) // "on_pushButton_3_clicked"
    ...
    "StartWindow\0SendData\0\0on_pushButton_clicked\0"
...
void StartWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SendData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4]))); break;
        ...
        {
            using _t = void (StartWindow::*)(int , int , int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartWindow::SendData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StartWindow::SendData(int _t1, int _t2, int _t3, QString _t4)
{
