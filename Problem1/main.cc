...
namespace std{
    ...
    double runtime_old_posy = static_cast<double>((end - start)/CLOCK_PER_SEC);
    ...
    double runtime_new_poly = static_cast<double>((end - start)/CLOCK_PER_SEC);
    ...
    double runtime_new_posy = static_cast<double>((end - start)/CLOCK_PER_SEC;
